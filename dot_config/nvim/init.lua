...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c_sharp', 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'typescript', 'help', 'svelte' },
...
local omnisharp_bin = "/Users/mg/.local/share/nvim/mason/packages/omnisharp/OmniSharp"
-- on Windows
